 ...
 *
 * @param {ParsedSongInfo} parsedData Object contains custom parsed data values
 * @param {ProcessedSongInfo} [processedData] Object contains custom processed data values
 *
