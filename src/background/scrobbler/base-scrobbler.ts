...
export default abstract class BaseScrobbler {
	 ...
	 *
	 * @return {Promise<string>} Auth URL
	 */
	 ...
	 *
	 * @param {SongInfo} songInfo Object containing song info
	 *
	 * @return {Promise<ApiCallResult>} Result
	 */
	 ...
	 *
	 * @param {SongInfo} songInfo Song info object
	 *
	 * @return {Promise<ScrobblerSongInfo>} Song info from scrobble service.
	 */
	 ...
	 *
	 * @return {String} Storage namespace name
	 */
	 ...
	 *
	 * @param {ApiCallResultType} resultType ApiCallResult type
	 *
	 * @return {ApiCallResult} ApiCallResult object
	 */
	 ...
	 * @param {LogType} [logType=log] Log type
	 */
