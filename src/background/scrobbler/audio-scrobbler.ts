...
export default abstract class AudioScrobbler extends BaseScrobbler {
	 ...
	 * @param {AudioScrobblerApiParams} params Object of key => value url parameters
	 ...
	 *
	 * @param {AudioScrobblerApiParams} params Parameters of API method
	 *
	 ...
	 *
	 * @param {AudioScrobblerResponse} responseData Response data
	 *
	 * @return {ApiCallResult} Response result
	 */
