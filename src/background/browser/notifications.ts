 ...
 *
 * @return {Promise<boolean>} Check result
 */
 ...
 * @param {OnClickedListener} callback Function that will be called on notification click
 */
 ...
 * Show a notification.
 *
 * @param {notifications.CreateNotificationOptions} options Notification options
 * @param {OnClickedListener} [onClick] Function that will be called on notification click
 *
 * @return {Promise<string>} Notification ID
 */
 ...
 *
 * @param {Song} song Copy of song instance
 ...
 *
 * @param {BaseScrobbler} scrobbler Scrobbler instance
 * @param {OnClickedListener} [onClick] Function that will be called on notification click
 */
 ...
 *
 * @param {OnClickedListener} onClicked Function that will be called on notification click
 */
