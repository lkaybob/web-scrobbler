 ...
 * given result type.
 *
 * @param {ApiCallResult[]} results Array of ApiCallResult objects
 ...
 *
 * @param {unknown} value Value to be hidden
 *
 ...
 *
 * @param {ApiCallResult[]} results Array of ApiCallResult objects
 * @param {ApiCallResultType} resultType ApiCallResult result type to check
 *
 ...
 *
 * @return {Promise<T>} Promise that will be resolved when the task has complete
 */
 ...
 *
 * @param {number} n Number value to check
